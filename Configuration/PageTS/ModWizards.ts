            ...
            bootstrap {
                ...
                elements {
                    ...
                    bootstrap_package_tabs {
                        icon = gfx/c_wiz/regular_header.gif
                        title = LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:content_element.tabs
                        description = LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:content_element.tabs.description
                        tt_content_defValues {
                            CType = bootstrap_package_tabs
                        }
                    }
                }
                show = *
