...
CREATE TABLE tt_content (
    ...
    tx_bootstrappackage_tabs_item int(11) unsigned DEFAULT '0'
...
#
# Table structure for table 'tx_bootstrappackage_tabs_item'
#
CREATE TABLE tx_bootstrappackage_tabs_item (
    uid int(11) NOT NULL auto_increment,
    pid int(11) DEFAULT '0' NOT NULL,
...
#
CREATE TABLE pages (
    tx_bootstrappackage_menu_state int(11) unsigned DEFAULT '0'
