...
$GLOBALS['TCA']['tt_content']['columns']['CType']['config']['items'] = array(
    ...
    array(
        'LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/Backend.xlf:content_element.tabs',
        //'TAB Element',
        'bootstrap_package_tabs',
        'i/tt_content_header.gif'
    )
);
 ...
 */
$tabs_columns = array(
    'tx_bootstrappackage_tabs_item' => array(
        'label' => 'LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/Backend.xlf:tabs_item',
        'config' => array(
            'type' => 'inline',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTCAcolumns('tt_content',$tabs_columns);
unset($tabs_columns);
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_bootstrappackage_tabs_item');
$TCA['tx_bootstrappackage_tabs_item'] = array(
    'ctrl' => array(
        ...
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'title' => 'LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/Backend.xlf:tabs_item',
        'delete' => 'deleted',
        'versioningWS' => 2,
        'versioning_followPages' => TRUE,
        'origUid' => 't3_origuid',
        ...
        'dynamicConfigFile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY) . 'Configuration/TCA/TabsItem.php',
        'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY) . 'Resources/Public/Icons/bootstrap_package_item_tabs.gif'
    ),
);
$TCA['tt_content']['types']['bootstrap_package_tabs']['showitem'] = "
    --palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.general;general,
    --palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.headers;bootstrap_package_header,
    tx_bootstrappackage_tabs_item,
    --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.appearance,
    --palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.frames;frames,
    --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,
    --palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.visibility;visibility,
...
/***************
 * MU : weijtere Felder für tt_content
 * anzeigen der Pages im Menü steuern über dieses Feld
 * Zustände :   0  =>   default
 *              1  =>   right-only
 *              2  =>   right-no
 *              3  =>   show-subitems
*               4  =>   right-no show-subitems
 */
$menu_columns = array(
    'tx_bootstrappackage_menu_state' => array(
        'label' => 'LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/Backend.xlf:menu_state',
        'config' => array(
            'type' => 'select',
            'items' => array(
                array('LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/Backend.xlf:menu_state.0', '0'),
                array('LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/Backend.xlf:menu_state.1', '1'),
                array('LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/Backend.xlf:menu_state.2', '2'),
                array('LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/Backend.xlf:menu_state.3', '3'),
                array('LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/Backend.xlf:menu_state.4', '4'),
            ),
            'size' => '1',
            'maxitems'  => '1',
        ),
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTCAcolumns('pages',$menu_columns);
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes(
    'pages',
    'tx_bootstrappackage_menu_state',
    '',
    'after:nav_hide'
);
